...
* Week 3: MaaS, PaaS, SaaS and Web Services 
  * JSON, REST, RPC, PaaS: Platform as a Service, SaaS: Software as a Service, MaaS : Metal as a Service, FaaS: Function as a Service (server-less architecture), MBaaS: Mobile Backend as a Service
  * Load Balancing
