...
* Week 3: MaaS, PaaS, SaaS and Web Services 
  * JSON, REST, RPC, PaaS: Platform as a Service, SaaS: Software as a Service, MaaS : Metal as a Service, FaaS: Function as a Service (server-less architecture), MBaaS: Mobile Backend as a Service, Load Balancing, Server-less architecture
  * Amazon lambda
...
* Week 4: Graph Processing and Machine Learning
  ...
  * Deep Learning: Introduction, Problems of Scaling Neural Nets to Big Data, Benefits of Layers, Theano, Tensor Flow, CNTK, Mxnet, Caffe on Spark
